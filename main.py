...
# and removing this sleep:::         #there is also a sleep between each one of the 4 thread checking for situations that the bot
    ...
    def contains_target_words(self, s):
        return 1 if re.search(r'(scam|cheat|trash|suck|valve|sus|vac|respect|leader|trol|idiot|hack|loser|report|ban|bot|factor|AI|death|celebrate|contribut|bug|mistake)', s, re.IGNORECASE) else 0
