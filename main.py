...
# and removing this sleep:::         #there is also a sleep between each one of the 4 thread checking for situations that the bot
        ...
        <how-to-response-format>
            ...
            <remember-important>if someone spams, then tell him that he is spamming and that you have been reported him. for example TOO LONG posts, or posts such as "sadgcx" or "fr" are not smart, and they are spamming and you should tell those that they being disrespectful towards the respected cs2 community members.</remember-important>
        </how-to-response-format>
